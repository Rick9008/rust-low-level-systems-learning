...
| **8/10 一** | **deep dive 10:00–10:45(Ulysses Kao,meet kbq-myia-tvk)**;08:30 起即可 | 收帳:全程紀錄入庫。**20:00 mock with William**(他也面 Etched Supercomputing SWE;Withers 當面試官,考 thread pool + submit with JobHandle——當考官=主動回憶,順練 8/11)。**mock 前後仍跑 Jan 場輕 taper**(量 ≤1h:`scratch/taper_0805.md` §E 掃讀 + §B 殘項默寫 + 兩皮串味複掃 + 8/6 洞清單三條;不碰新題不開 oracle),00:00 前熄燈(9:15 場 07:45 起) |
