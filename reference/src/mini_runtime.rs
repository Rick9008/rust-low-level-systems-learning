...
//!
//! ## [Clarify]
//! 解決:[`crate::executor`] 只能 `block_on` 一個 future、
//! [`crate::event_loop`] 只會回報 readiness——兩者之間缺的就是
...
//! - [`EpollPoller`](V1):包 [`crate::event_loop::EventLoop`],
...
//! 3. interest table 就是 [`crate::fd_registry::FdRegistry`]`<Waker>`:
...
//!   spawn_blocking,本 repo 的 [`crate::file_io_offload`])。
...
use crate::event_loop::{EventLoop, Events, Interest, Token as ElToken, Trigger};
