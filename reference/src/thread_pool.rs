...
//! async 版是 [`crate::file_io_offload::spawn_blocking`](waker 版,同語意)。
...
//!   ([`JobHandle`])。與 [`crate::file_io_offload::JoinFuture`] 是**同一個
...
/// 對照 [`crate::file_io_offload::JoinFuture`](waker 睡):同一語意、兩種睡法。
