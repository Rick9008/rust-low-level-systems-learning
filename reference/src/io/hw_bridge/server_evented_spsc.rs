...
//! (outbox);本版換成兩條 [`crate::concurrency::spsc_ring`]:
//!
//! ```text
...
//!   [`crate::concurrency::signal_pipeline`] 同款,含 SeqCst fence 的 SB litmus 分析);
...
use crate::concurrency::spsc_ring::{Consumer, Producer, channel};
use crate::io::event_loop::{Event, EventLoop, Events, Interest, Token, Trigger, WakeHandle};
