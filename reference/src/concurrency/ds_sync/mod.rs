...
//! | 結構 | 單執行緒 | 鎖版 | 無鎖版 |
//! |------|----------|------|--------|
//! | bounded queue | [`crate::ds::ring_buffer`] | [`crate::concurrency::bounded_queue`] (+condvar) | [`crate::concurrency::spsc_ring`] |
//! | arena / slab | — | [`arena_locked`] | [`crate::concurrency::arena_lockfree`] |
