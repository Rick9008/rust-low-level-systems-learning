...
mod tests {
    ...
    #[test]
    #[ignore = "填完 keep_and_double_positives 後移除"]
    ...
    #[test]
    #[ignore = "填完 reverse_in_place 後移除"]
    ...
    #[test]
    #[ignore = "填完 EventLog::compact 後移除"]
