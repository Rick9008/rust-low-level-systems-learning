...
> **R2 攝取進度(8/3 凌晨快照)**:i-lite ✅ 7/30|j 全場 ✅ 7/31 錶內|k lite ✅ 8/1|m 全場 ✅ 8/2(65m+20,場後修帳 3/3 綠)|l lite ✅ 8/2 深夜(4/4)|sim o ✅ 8/3(填空 8/8 綠)|**n lite ✅ 8/3 晚(clarify 改制版;附 async 兩皮默寫 7 錯→0)= R2 攝取全收**|8/4 背靠背全新題 ×2 + 認題卡 FR/AG-R/TA/AG-T|8/5 taper(a–n 翻閱 30m)|輕敘事日誌重啟:[journal.md](journal.md)。
...
5. **約期口徑(7/28 晚定;HR call 已定 7/29 早)**:先問(下一關形式/考官/時長/語言/剩幾關/出結果時程)再報時間,**給區間不給單點**——culture fit:「7/31 之後都可」、舒適引導 8/3(隔週末排練一次);coding:8/4–8/5(留完整週末 2 場針對練習);兩關都有 → culture fit 先。**時段爭取 10:30 以後**(睡眠債未還,不再簽 8:45 強行軍)。底線:culture fit 不早於 7/31、coding 不早於 8/3。HR call 後再收帳一次(屆時知道真正下一關)。
