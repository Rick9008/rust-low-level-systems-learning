...
| **7/22 三** | **卡#5 口述設計版開場**(25–30m:sensor bridge 分 threads/tasks + 定通訊協定 + 五問,JD 複核 #4)→ 🔴**c#1 frame_parser_heartbeat**(45+30m)→ 修 e2#1 的洞(45m;已於 7/21 晚修畢,只剩回放+紅測複核 ~15m)→ **spsc 空白 #2**(20m)。〔v8.1〕日讀 p8 排 **c#1 回放之後**(晚尾;executor challenge 已 7/21 晚完成,晚尾釋放) | ~3h |
